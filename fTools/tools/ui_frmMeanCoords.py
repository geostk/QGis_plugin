...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.weightField.setObjectName(_fromUtf8("weightField"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_weight.setText(_translate("Dialog", "Weight field", None))
        self.label_unique.setText(_translate("Dialog", "Unique ID field", None))
